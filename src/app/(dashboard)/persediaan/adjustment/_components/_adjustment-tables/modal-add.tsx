...
const formSchema = z.object({
  ...
  jumlahAdjustment: z.string().min(1, "Jumlah Adjustment Harga wajib diisi"),
            ...
            <div className="grid grid-cols-2 gap-6 mt-4">
              ...
              <div className="space-y-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Nomor dan Tanggal Adjustment</FormLabel>
                      <FormControl>
                        <Input
              ...
              <div className="space-y-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Upload Document BA Close Project</FormLabel>
                      <FormControl>
                        <Input
                          placeholder="Masukkan Nomor Transaksi"                          
                          {...field}
            ...
            <div className="grid grid-cols-2 gap-6 mt-4">
              ...
              <div className="space-y-4">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Jumlah On-Hand</FormLabel>
                      <FormControl>
                        <Input
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Jumlah Kelompok Barang/Material</FormLabel>
                      <FormControl>
                        <Input
                          placeholder="Masukkan Jumlah Tersedia"
                          {...field}
...
<FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Nama Eks Proyek</FormLabel>
                      <FormControl>
                        <Input placeholder="Masukkan UOM" {...field} />
                      </FormControl>
                      <FormMessage />
